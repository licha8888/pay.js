define(["jquery", "easy-admin", "echarts", "echarts-theme", "miniAdmin", "miniTab"], function ($, ea, echarts, undefined, miniAdmin, miniTab) {
    ...
    var Controller = {
        ...
        welcome: function () {
            ...
            echartsData = {};
            $.ajaxSettings.async = false; //ajax 下 必须设置为同步模式 回调函数内才能给全局变量赋值
            $.post('welcome', {}, function (res) {
                echartsData = res
            });
            ...
            var optionRecords = {
                ...
                series: [
                    {
                        name: echartsData['title'][0],
                        type: 'line',
                        stack: '总量',
                        data: echartsData['data'][0]
                    },
                    {
                        name: echartsData['title'][1],
                        type: 'line',
                        stack: '总量',
                        data: echartsData['data'][1]
                    },
                    {
                        name: echartsData['title'][2],
                        type: 'line',
                        stack: '总量',
                        data: echartsData['data'][2]
                    },
                    {
                        name: echartsData['title'][3],
                        type: 'line',
                        stack: '总量',
                        data: echartsData['data'][3]
                    },
                    {
                        name: echartsData['title'][4],
                        type: 'line',
                        stack: '总量',
                        data: echartsData['data'][4]
                    }
                ]
            };
